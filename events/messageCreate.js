...
module.exports = async (client) => {
    client.on('messageCreate', async (message) => {
        ...
        try {
            ...
            let scot = 0
            let slink = 'https://discord.gg/mkcxugfnna'
                    ...
                    .send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(`#0x2b2d31`)
                                .setDescription(
                                    `Your Premium Has Got Expired.\nTotal **\`${scot}\`** Servers [Premium](https://discord.gg/mkcxugfnna) was removed.\nClick [here](https://discord.gg/mkcxugfnna) To Buy [Premium](https://discord.gg/mkcxugfnna).`
                                )
                        ],
                        components: [premrow]
                    })
                            ...
                            .send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(`#0x2b2d31`)
                                        .setDescription(
                                            `Your Premium Has Got Expired.\nTotal **\`${scount}\`** Servers [Premium](https://discord.gg/mkcxugfnna) was removed.\nClick [here](https://discord.gg/mkcxugfnna) To Buy [Premium](https://discord.gg/mkcxugfnna).`
                                        )
                                ],
                                components: [premrow]
                            })
            ...
            const row = new MessageActionRow().addComponents(
                ...
                new MessageButton()
                    .setLabel(`Support`)
                    .setStyle('LINK')
                    .setURL(`https://discord.com/invite/Sruby-hq`)
            )
            ...
            if (
                !'870991045008179210'.includes(message.author.id) &&
                !uprem &&
                !sprem
            ) {
                const row = new MessageActionRow().addComponents(
                    ...
                    new MessageButton()
                        .setLabel('Premium')
                        .setStyle('LINK')
                        .setURL('https://discord.gg/MKCxUgFNnA')
                )
                    ...
                    if (now < expirationTime) {
                        ...
                        if (commandCount > commandLimit) {
                            ...
                            const ricky = new MessageEmbed()
                                ...
                                .addField(
                                    'Support Server',
                                    '[Join our support server](https://discord.gg/MKCxUgFNnA )',
                                    true
                                )
                                .setTimestamp()
