                                        ...
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:tk:1304818061034917979> | Success! The ${role} role has been successfully added to my Automod bypass role list.`
                                                    )
                                            ]
                                        })
                                    } else {
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:crs:1304817967413854209> | Oops! It appears that ${role} is already in my Automod bypass role list.`
                                                    )
                                            ]
                                        })
                                    }
                                        ...
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:tk:1304818061034917979> | Success! The ${role} has been successfully removed from my Automod role bypass list.`
                                                    )
                                            ]
                                        })
                                    } else {
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:crs:1304817967413854209> | Oops! It appears that the ${role} is not on my Automod role bypass list.`
                                                    )
                                            ]
                                        })
                                    }
                                    ...
                                    return message.channel.send({
                                        embeds: [
                                            new MessageEmbed()
                                                .setColor(client.color)
                                                .setDescription(
                                                    `<a:crs:1304817967413854209> | Oops! It seems there was an issue. Please make sure to provide a valid role.`
                                                )
                                        ]
                                    })
                                }
                                    ...
                                    return message.channel.send({
                                        embeds: [
                                            new MessageEmbed()
                                                .setColor(client.color)
                                                .setDescription(
                                                    `<a:crs:1304817967413854209> | Oops! It seems like there's no designated Automod bypass role set up in this server. No worries, though! You can easily configure one to enhance your experience.`
                                                )
                                        ]
                                    })
                                }
                                        ...
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:tk:1304818061034917979> | Success! The ${user} role has been successfully added to my Automod bypass user list.`
                                                    )
                                            ]
                                        })
                                    } else {
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:crs:1304817967413854209> | Oops! It appears that ${user} is already in my Automod bypass user list.`
                                                    )
                                            ]
                                        })
                                    }
                                        ...
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:tk:1304818061034917979> | Success! The ${user} has been successfully removed from my Automod bypass user list.`
                                                    )
                                            ]
                                        })
                                    } else {
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:crs:1304817967413854209> | Oops! It appears that the ${user} is not on my Automod bypass user list.`
                                                    )
                                            ]
                                        })
                                    }
                                    ...
                                    return message.channel.send({
                                        embeds: [
                                            new MessageEmbed()
                                                .setColor(client.color)
                                                .setDescription(
                                                    `<a:crs:1304817967413854209> | Oops! It seems there was an issue. Please make sure to provide a valid user.`
                                                )
                                        ]
                                    })
                                }
                                        ...
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:tk:1304818061034917979> | Success! The ${channel} channel has been successfully added to my Automod bypass channel list.`
                                                    )
                                            ]
                                        })
                                    } else {
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:crs:1304817967413854209> | Oops! It appears that ${channel} is already in my Automod bypass channel list.`
                                                    )
                                            ]
                                        })
                                    }
                                        ...
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:tk:1304818061034917979> | Success! The ${channel} has been successfully removed from my Automod channel bypass list.`
                                                    )
                                            ]
                                        })
                                    } else {
                                        return message.channel.send({
                                            embeds: [
                                                new MessageEmbed()
                                                    .setColor(client.color)
                                                    .setDescription(
                                                        `<a:crs:1304817967413854209> | Oops! It appears that the ${channel} is not on my Automod channel bypass list.`
                                                    )
                                            ]
                                        })
                                    }
                                    ...
                                    return message.channel.send({
                                        embeds: [
                                            new MessageEmbed()
                                                .setColor(client.color)
                                                .setDescription(
                                                    `<a:crs:1304817967413854209> | Oops! It seems there was an issue. Please make sure to provide a valid channel.`
                                                )
                                        ]
                                    })
                                }
                                    ...
                                    return message.channel.send({
                                        embeds: [
                                            new MessageEmbed()
                                                .setColor(client.color)
                                                .setDescription(
                                                    `<a:crs:1304817967413854209> | Oops! It seems like there's no designated Automod bypass channel set up in this server. No worries, though! You can easily configure one to enhance your experience.`
                                                )
                                        ]
                                    })
                                }
