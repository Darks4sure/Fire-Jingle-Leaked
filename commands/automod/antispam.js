            ...
            case 'enable':
                if (!isActivatedAlready) {
                    ...
                    const antispamEnableMessage = new MessageEmbed()
                        ...
                        .setDescription(
                            '**<a:tk:1304818061034917979> | Congratulations! Antispam has been successfully enabled on your server.**'
                        )
                        .addField(
                            'Enhanced Protection',
            ...
            case 'disable':
                if (isActivatedAlready) {
                    ...
                    const embedMessage = new MessageEmbed()
                        ...
                        .addField(
                            'Impact',
                            '<a:tk:1304818061034917979> | Your server will no longer be protected against spam messages.'
                        )
                        .setTimestamp()
                        .setFooter(
                            client.user.username,
                    ...
                    const embedMessage = new MessageEmbed()
                        ...
                        .addField(
                            'Current Status',
                            `<a:tk:1304818061034917979> | Antispam is already disabled on your server.\n\nCurrent Status: ${disable}`
                        )
                        .addField(
                            'To Enable',
                            `To enable Antispam, use \`${prefix}antispam enable\``
            ...
            case 'punishment':
                ...
                if (punishment === 'ban') {
                    ...
                    const embedMessage = new MessageEmbed()
                        ...
                        .setDescription(
                            'T<a:tk:1304818061034917979> | he anti-spam punishment has been successfully configured.'
                        )
                ...
                if (punishment === 'kick') {
                    ...
                    const embedMessage = new MessageEmbed()
                        ...
                        .setTitle('Anti-Spam Punishment Configured')
                        .setDescription(
                            '<a:tk:1304818061034917979> | The anti-spam punishment has been successfully configured.'
                        )
            ...
            case 'limit':
                ...
                if (limit >= 4 && limit <= 10) {
                    ...
                    const embedMessage = new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:tk:1304818061034917979> | **Spam Threshold Updated**`
                        )
                    ...
                    const embedMessage = new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | **Error: Invalid Message Count Limit**`
                        )
                        .addField(
                            'Valid Range',
