...
const disabled = '<:crosss:1218087334382272552>'
const enabled = '<:IconTick:1218087191792586812>'
                ...
                embeds: [
                    new MessageEmbed()
                        ...
                        .addFields([
                            {
                                name: '__About__',
                                value: `**Name**: ${guild.name} \n **ID**: ${guild.id} \n **Owner <a:owner:1208424663127035966>:** <@!${guild.ownerId}> (${guild.ownerId})\n**Created at:** <t:${parseInt(createdTimestamp / 1000)}:R>\n**Members: **${guild.memberCount}\n**Banned Members: **${bans}`
                            },
                            {
                            ...
                            {
                                name: '__Channels__',
                                value: `**Total: ** ${channels.size}\n**Channels: **<:stolen_emoji:1245706228110463018> ${channels.filter((channel) => channel.type === 'GUILD_TEXT').size} | <:stolen_emoji:1245602796636471326> ${channels.filter((channel) => channel.type === 'GUILD_VOICE').size}`
                            },
                            {
                                name: '__Emoji Info__',
                            ...
                            },
                            {
                                ...
                                value: `${booster[guild.premiumTier]} [<a:boostbadge:1245257853095383081> ${guild.premiumSubscriptionCount || '0'} Boosts]`
                            },
                            {
