                ...
                return message.channel.send({
                    embeds: [
                        embed
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | You didn't provided a valid role.\n\`${message.guild.prefix}role all <role>\``
                            )
                    ]
                })
            }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | You didn't used the command correctly.\n\`${message.guild.prefix}role <user> <role>\``
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | This Role Is Managed By Integration`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | I can't provide this role as my highest role is either below or equal to the provided role.`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | I can't provide this role as your highest role is either below or equal to the provided role.`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<a:tk:1304818061034917979> | Successfully removed <@&${role.id}> from <@${member.id}>.`
                        )
                ]
            })
        } else {
            ...
            return message.channel.send({
                embeds: [
                    embed
                        .setColor(client.color)
                        .setDescription(
                            `<a:tk:1304818061034917979> | Successfully added <@&${role.id}> to <@${member.id}>.`
                        )
                ]
            })
        }
