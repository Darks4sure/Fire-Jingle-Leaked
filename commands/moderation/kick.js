...
module.exports = {
    ...
    run: async (client, message, args) => {
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setDescription(
                            `<a:crs:1304817967413854209> | You must have \`Kick Members\` permissions to use this command.`
                        )
                ]
            })
        }
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | You can't kick me.`
                        )
                ]
            })
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | I can't kick the owner of this server.`
                        )
                ]
            })
        ...
        const done = new MessageEmbed()
            .setDescription(
                `<a:tk:1304818061034917979> | Successfully kicked **${user.user.tag}** from the server.`
            )
            .setColor(client.color)
