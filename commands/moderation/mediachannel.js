            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        ...
                        .setDescription(
                            `<a:crs:1304817967413854209> | You must have \`MANAGE SERVER\` permissions to use this command.`
                        )
                ]
            });
        }
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | Oops! It seems there was an issue. Please make sure to provide a valid channel for the media configuration.`
                            )
                    ]
                })
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | You cannot add any voice channels as media channel `
                            )
                    ]
                })
            }
                ...
                message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:tk:1304818061034917979> | Successfully Added ${channel} As Media Only Channel`
                            )
                    ]
                })
            }
                ...
                message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:tk:1304818061034917979> | There Is No Media Only Channel Configuration In This Server.!`
                            )
                    ]
                })
            } else if (data) {
                ...
                message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:tk:1304818061034917979> | Successfully Disabled Media Only Configuration.!`
                            )
                    ]
                })
            }
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | No Media Only configured is Set.!`
                            )
                    ]
                })
