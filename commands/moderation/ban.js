...
module.exports = {
    ...
    run: async (client, message, args) => {
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | I must have \`Ban Members\` permissions to use this command.`
                        )
                ]
            })
        }
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | Please Provide Valid user ID or Mention Member.`
                            )
                    ]
                })
            }
        ...
        const kaalo = new MessageEmbed()
            .setDescription(`<a:crs:1304817967413854209>| User Not Found`)
            .setColor(client.color)
        if (user === undefined)
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | If You Ban Me Then Who Will Protect Your Server Dumb!?`
                        )
                ]
            })
            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | I can't ban the owner of this server.`
                        )
                ]
            })
        ...
        if (check === true || user.banable) {
            try {
                ...
                const embed = new MessageEmbed()
                    .setDescription(
                        `<a:crs:1304817967413854209> |  My highest role is below **<@${user.id}>** `
                    )
                    .setColor(client.color)
            ...
            const done = new MessageEmbed()
                .setDescription(
                    `<a:tk:1304818061034917979> | Successfully banned **<@${user.id}>** from the server.`
                )
                .setColor(client.color)
        ...
        if (check === false) {
            try {
                ...
                const embed = new MessageEmbed()
                    .setDescription(
                        `<a:crs:1304817967413854209> |  My highest role is below or same as **<@${user.id}>** `
                    )
                    .setColor(client.color)
                return message.channel.send({ embeds: [embed] })
            }
