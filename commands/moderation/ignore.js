                                ...
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:tk:1304818061034917979> | Success! ${channel} has been successfully added to my ignore list.`
                                            )
                                    ]
                                })
                            } else {
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:crs:1304817967413854209> | Oh no! It looks like ${channel} is already in my ignore list.`
                                            )
                                    ]
                                })
                            }
                            ...
                            return message.channel.send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(client.color)
                                        .setDescription(
                                            `<a:crs:1304817967413854209> | Oops! It seems there was an issue. Please make sure to provide a valid channel for the ignore list.`
                                        )
                                ]
                            })
                        }
                                ...
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:tk:1304818061034917979> | Success! ${channel} has been successfully removed from my ignore list.`
                                            )
                                    ]
                                })
                            } else {
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                ` <a:crs:1304817967413854209> | Oops! It appears that ${channel} is not on my ignore list.`
                                            )
                                    ]
                                })
                            }
                            ...
                            return message.channel.send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(client.color)
                                        .setDescription(
                                            `<a:crs:1304817967413854209> | Oops! It seems like there's no designated ignore channel set up in this server. No worries, though! You can easily configure one to enhance your experience.`
                                        )
                                ]
                            })
                        }
                                ...
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:tk:1304818061034917979> | Success! The ${role} role has been successfully added to my ignore bypass list.`
                                            )
                                    ]
                                })
                            } else {
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:crs:1304817967413854209> | Oops! It appears that ${role} is already in my ignore bypass list.`
                                            )
                                    ]
                                })
                            }
                            ...
                            return message.channel.send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(client.color)
                                        .setDescription(
                                            `<a:crs:1304817967413854209> | Oops! It seems there was an issue. Please ensure you've provided a valid role for the ignore bypass list.`
                                        )
                                ]
                            })
                        }
                                ...
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:tk:1304818061034917979> | Success! The ${role} has been successfully removed from my ignore bypass list.`
                                            )
                                    ]
                                })
                            } else {
                                return message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                ` <a:crs:1304817967413854209> | Oops! It appears that the ${role} is not on my ignore bypass list.`
                                            )
                                    ]
                                })
                            }
                            ...
                            return message.channel.send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(client.color)
                                        .setDescription(
                                            `<a:crs:1304817967413854209> | Oops! It seems like there's no designated ignore bypass role set up in this server. No worries, though! You can easily configure one to enhance your experience.`
                                        )
                                ]
                            })
                        }
