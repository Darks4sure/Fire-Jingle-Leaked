        ...
        if (input === 'add') {
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | ${message.guild.prefix}setup add <name> <role>`
                            )
                    ]
                })
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | **Custom role** names cannot contain **mentions**. Please provide a different **name**.`
                            )
                    ]
                });
            }
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | ${message.guild.prefix}setup add ${args[1]} <role>`
                            )
                    ]
                })
            const role =
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | Role **not** found!`
                            )
                    ]
                })
            if (role.managed)
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | <@&${role.id}> isn't a **server** role!`
                            )
                    ]
                })
            let array = [
            ...
            if (
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setDescription(
                                `<a:crs:1304817967413854209> | I can't **add** <@&${role.id}> in my **custom role** list because it has ${new Permissions(
            ...
            if (roleIndex === -1) {
                const embed = new MessageEmbed()
                    .setColor(client.color)
                    .setDescription(
                        `<a:crs:1304817967413854209> | Oops! The role with the name **${roleName}** couldn't be found in my custom role setups. Double-check the name and try again.`
                    )
                return message.channel.send({ embeds: [embed] })
            }
            ...
            if (!data) {
                const embed = new MessageEmbed()
                    ...
                    .setDescription(
                        `<a:crs:1304817967413854209> | Oops! There's nothing to display for custom role setups.`
                    )
                    .setAuthor({
                        name: message.guild.name,
                        iconURL:
            ...
            if (
                ...
                const embed = new MessageEmbed()
                    .setColor(client.color)
                    .setTitle(`<a:crs:1304817967413854209> Role Position Issue`)
                    .setDescription(
