                                ...
                                message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<:IconTick:1245261305561223199> | successfully added ${role} as vcrole human.!`
                                            )
                                    ]
                                })
                            } else {
                                message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<a:crs:1304817967413854209> | this role is having dangerous permissions.!`
                                            )
                                    ]
                                })
                            }
                            ...
                            return message.channel.send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(client.color)
                                        .setDescription(
                                            `<a:crs:1304817967413854209> | please provide a valid role mention or id to set as vcrole!`
                                        )
                                ]
                            })
                        }
                            ...
                            return message.channel.send({
                                embeds: [
                                    new MessageEmbed()
                                        .setColor(client.color)
                                        .setDescription(
                                            `<a:crs:1304817967413854209> | you cannot add any integrated role in My vcrole.! `
                                        )
                                ]
                            })
                        }
                                ...
                                message.channel.send({
                                    embeds: [
                                        new MessageEmbed()
                                            .setColor(client.color)
                                            .setDescription(
                                                `<:IconTick:1245261305561223199> | successfully added ${role} as vcrole bot.!`
                                            )
                                    ]
                                })
                            } else {
                        ...
                        return message.channel.send({
                            embeds: [
                                new MessageEmbed()
                                    .setColor(client.color)
                                    .setDescription(
                                        `<a:crs:1304817967413854209> | No vcrole is configured.!`
                                    )
                            ]
                        })
                    } else {
                        ...
                        message.channel.send({
                            embeds: [
                                new MessageEmbed()
                                    .setColor(client.color)
                                    .setDescription(
                                        `<a:crs:1304817967413854209> | there is no vcrole in this server.!`
                                    )
                            ]
                        })
                    } else if (
                        ...
                        message.channel.send({
                            embeds: [
                                new MessageEmbed()
                                    .setColor(client.color)
                                    .setDescription(
                                        `<:IconTick:1245261305561223199> | successfully disabled vcrole configuration.!`
                                    )
                            ]
                        })
                    }
