            ...
            return message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | **Only Server Owner Can Run This Command.!**`
                        )
                ]
            })
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | **You Cannot Add Any Bots to Extraowner** `
                            )
                    ]
                })
            }
                ...
                message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:tk:1304818061034917979> | **Successfully Added ${user} As Extraowner**`
                            )
                    ]
                })
            }
                ...
                message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:tk:1304818061034917979> | **There Is No Extraowner Configuration In This Server.!**`
                            )
                    ]
                })
            } else if (data) {
                ...
                message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:tk:1304818061034917979> | **Successfully Disabled Extraowner Configuration.!**`
                            )
                    ]
                })
            }
                ...
                return message.channel.send({
                    embeds: [
                        new MessageEmbed()
                            .setColor(client.color)
                            .setDescription(
                                `<a:crs:1304817967413854209> | **No Extraowner is Set.!**`
                            )
                    ]
                })
