            ...
            message.channel.send({
                embeds: [
                    new MessageEmbed()
                        .setColor(client.color)
                        .setDescription(
                            `<a:crs:1304817967413854209> | **Seems that antinuke module is not enabled in this server.**`
                        )
                ]
            })
        } else {
                    ...
                    message.channel.send({
                        embeds: [
                            new MessageEmbed()
                                .setColor(client.color)
                                .setDescription(
                                    `<a:crs:1304817967413854209> | **Please again run this command as the database was earlier not assigned.**`
                                )
                        ]
                    })
                } else {
                        ...
                        return message.channel.send({
                            embeds: [
                                new MessageEmbed()
                                    .setColor(client.color)
                                    .setDescription(
                                        `<a:tk:1304818061034917979> | **Successfully reset the whitelisted members list.**`
                                    )
                            ]
                        })
                    } else {
                        message.channel.send({
                            embeds: [
                                new MessageEmbed()
                                    .setColor(client.color)
                                    .setDescription(
                                        `<a:crs:1304817967413854209> | **There are no whitelisted members in this server.**`
                                    )
                            ]
                        })
                    }
