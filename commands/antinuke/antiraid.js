...
// Anti-raid related constants
let raidDetected = `<a:warning:123456789012345678>`;  // Example warning emoji for raid detection
...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        // Check if Anti-Raid Mode is enabled or disabled
        let configEmbed;
